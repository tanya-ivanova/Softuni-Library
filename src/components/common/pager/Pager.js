...
const Pager = ({ 
    ...
    return (
        <div >
            <div className={`${styles["position-right"]} ${styles.numberOfPages}`}>
                {languages.page[language]} {page} {languages.of[language]} {pages}
            </div>
            ...
            <div className={styles["position-right"]}>
                <Link 
                    to={linkToPrev} 
                    onClick={onClickPrev} 
                    className={`pageLink ${!linkToPrev ? "disabledCursor" : ''}`}
                >
                ...
                <Link 
                    to={linkToNext} 
                    onClick={onClickNext} 
                    className={`pageLink ${!linkToNext ? "disabledCursor" : ''}`}
                >
